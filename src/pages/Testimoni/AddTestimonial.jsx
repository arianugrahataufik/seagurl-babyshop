...
export default function AddTestimonial() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await testimonial.create(form);
      navigate("/testimoni");
    } catch (err) {
      setError("Gagal menambahkan testimoni: " + err.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-6 bg-[#E8DDD3] rounded-2xl">
      <Breadcrumb items={["Testimoni", "Tambah Testimoni"]} />
      <h2 className="text-2xl font-bold mt-4 mb-6">Tambah Testimoni Baru</h2>
