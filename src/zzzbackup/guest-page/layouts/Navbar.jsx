...
export default function Header() {
  return (
    <header id="header-container" className="bg-white shadow-sm">
      ...
      >
        ...
        <div id="logo" className="flex items-center space-x-2">
          <img
            ...
            className="w-8 h-8"
          />
          <span className="text-xl font-bold text-green-600">Medico</span>
        ...
        <div id="search-bar" className="flex flex-1 max-w-3xl mx-6">
          <div className="inline-flex items-center bg-gray-100 rounded-l-lg px-4 py-2 border border-gray-300 whitespace-nowrap">
            <span className="text-poppins-regular text-sm text-gray-600">All Categories</span>
          ...
          <input
            ...
            className="text-poppins-regular text-sm w-full px-4 py-2 border-t border-b border-gray-300 focus:outline-none"
          />
          <button className="bg-green-600 hover:bg-green-700 text-white px-4 rounded-r-lg">
            <FaSearch />
          </button>
        </div>
        ...
        <div
          id="icons"
          className="flex items-center space-x-6 text-gray-600 text-xl"
        >
      ...
      {/* Bottom Nav Links */}
      <nav className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-nunito-semibold text-gray-600 px-4 pb-3 md:px-8">
        {[
          "Pain Relief",
          "Cold and Flu",
          "Diabetes Care",
