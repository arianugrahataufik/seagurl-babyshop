...
function Typography(){
    return(
        <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg mt-2">Belajar Tailwind sangat menyenangkan</p>
        </div>
    )
}
...
function BorderRadius(){
    return (
        <button className="border-2 border-blue-500 text-blue-500 px-4 py-2 rounded-lg mb-8"> Klik Saya </button>
    )
}
...
function FlexboxGrid(){
    return (
        <nav className="flex justify-between bg-gray-800 p-4 text-white mb-8">
